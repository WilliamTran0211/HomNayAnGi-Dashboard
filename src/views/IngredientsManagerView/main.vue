      ...
      :data="sidebarData"
        ...
        >
                ...
                >
                    ...
                    >
                        <span class="mr-2">
                            ...
                            {{ ingredientsList.length - currentPage * itemsPerPage > 0 ? currentPage * itemsPerPage : ingredientsList.length }} of {{ queriedItems }}
                        </span>
            ...
            <template slot="thead">
                ...
                <vs-th sort-key="name">Tên Thực phẩm</vs-th>
                <vs-th sort-key="possible_unit">Đơn vị</vs-th>
                ...
                <tbody>
                    <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
                        ...
                        <vs-td>
                            <vs-chip
                                :key="chip"
                                v-for="chip in tr.possible_unit"
                                transparent
                                color="dark"
                            >{{ chip }}</vs-chip>
                        </vs-td>
...
<script>
import DataViewSidebar from './IngredientsDetailSideView';
...
export default {
    ...
    computed: {
        ...
        queriedItems() {
            return this.$refs.table ? this.$refs.table.queriedResults.length : this.ingredientsList.length;
        }
    },
    methods: {
        reloadData() {
