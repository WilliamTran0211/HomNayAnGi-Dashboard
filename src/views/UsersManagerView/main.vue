...
<template>
    ...
    />-->
        ...
        <vs-table ref="table" multiple v-model="selected" search pagination :data="usersList">
            ...
            <template slot="thead">
                ...
                <vs-th sort-key="full_name">Họ tên</vs-th>
                <vs-th sort-key="dislay_name">Tên hiển thị</vs-th>
                <vs-th sort-key="birthday">Ngày sinh</vs-th>
                <vs-th sort-key="gender">Giới tính</vs-th>
            ...
            <template slot-scope="{ data }">
                <tbody>
                    <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
                        ...
                        <vs-td>
                            <p class="product-price">{{ tr.birthday }}</p>
                        </vs-td>
        ...
        <vs-alert :title="alertTitle" :color="alertStyle" :active="alertActive" y>{{ alertMessage }}</vs-alert>
    </div>
</template>

<script>
import DataViewSidebar from './UsersDetailSideView';
...
export default {
    ...
    methods: {
        ...
        async getList() {
            ...
            await this.$store
                .dispatch('userManager/fetchUsers')
                .then((result) => {
                    console.log(result);
        ...
        toggleDataSidebar(datasibe = { val: false, isSubmit: undefined }) {
